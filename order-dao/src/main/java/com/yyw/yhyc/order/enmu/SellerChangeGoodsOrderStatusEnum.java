 ...
 */
public enum SellerChangeGoodsOrderStatusEnum {
    ...
    SellerChangeGoodsOrderStatusEnum(String type, String value) {
        this.type = type;
        this.value = value;
    }

    public static String getName(String type) {
        for (SellerChangeGoodsOrderStatusEnum item : SellerChangeGoodsOrderStatusEnum.values()) {
