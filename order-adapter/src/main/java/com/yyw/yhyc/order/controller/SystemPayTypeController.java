...
public class SystemPayTypeController extends BaseJsonController {
	...
	*/
	...
	{
		return systemPayTypeService.getByPK(key);
	}
	...
	*/
	...
	public Pagination<SystemPayType> listPgSystemPayType(RequestModel<SystemPayType> requestModel) throws Exception
	{
		...
		return systemPayTypeService.listPaginationByProperty(pagination, requestModel.getParam());
	}
	...
	*/
	...
	{
		systemPayTypeService.deleteByPKeys(requestListModel.getList());
	}
	...
	*/
	...
	{
		systemPayTypeService.update(systemPayType);
	}
}
