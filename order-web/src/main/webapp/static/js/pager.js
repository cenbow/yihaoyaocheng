...
$.fn.pager = function(opts){
    ...
    var PREVPAGE = '<a href="javascript:void(0)" class="pager_prev">\u4e0a\u4e00\u9875</a>',
        ...
        JUMPFROM = '<span class="page_total">共<em>'+total+'</em>页</span><span class="form_pageJump"><label>到<input type="text" name="page" class="input_item input_item_shortest" autocomplete="off" />页</label><a href="javascript:void(0)" class="btn_blue btn_submit" data-form-button="submit">确定</a></span>';
